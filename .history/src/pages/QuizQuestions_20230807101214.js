  ...
  return (
    <>
      ...
      {result ? (
        ...
        <Grid container spacing={3} sx={{ mb: 12,backgroundImage:URL("https://static.vecteezy.com/system/resources/previews/011/885/776/large_2x/green-freshness-nature-blur-background-concept-free-photo.jpg")}}>
          <Grid item xs={8}>
            <Card direction="row" alignItems="center" justifyContent="space-between">
              <Grid spacing={5} sx={{ m: 4 }}>
