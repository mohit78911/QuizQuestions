      ...
      {newTab ? (
        <Grid container sx={{ mb: 5 }}>
          <Grid item xs={11}>
            <Card direction="row">
              <Grid sx={{ m: 4 }}>
                <Typography>{score > 5 ? "Well Played ✌️" : "Better Luck Next Time 👍"}</Typography>
              </Grid>
            </Card>
          </Grid>
        </Grid>
              ...
              <Card direction="row" alignItems="center" justifyContent="space-between">
                ...
                <Typography sx={{ mb: 2, m: 4 }}>
                  ...
                  {question.map((value, i) => {
                    return (
                      <Typography sx={{}} key={i}>
                        <Typography sx={{display:"fl"}}>
                          Question No. {i + 1}.&nbsp;&nbsp;&nbsp;<Typography sx={{fontWeight:"bold"}}>{value.options[value.answer - 1]}</Typography>
                        </Typography>
                      </Typography>
                    );
                  })}
