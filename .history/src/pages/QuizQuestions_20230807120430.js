      ...
      {newTab ? (
        <Grid container sx={{ mb: 5 }}>
          <Grid item xs={11}>
            <Card direction="row">
              <Grid sx={{ m: 4 }}>
                <Typography>{score > 5 ? "Well Played" : "Better Luck Next Time What does the emoji 👍 mean?
What does 👍 Thumbs Up emoji mean? The thumbs-up emoji is used to express assent, approval, or encouragement in digital communications, especially in Western cultures.07-Mar-2018
                ...
                <Typography sx={{ mb: 2, m: 4 }}>
                  ...
                  {question.map((value, i) => {
                    return (
                      <Typography sx={{}} key={i}>
                        <Typography>
                          Question No. {i + 1}.&nbsp;&nbsp;&nbsp;{value.answer}{value.options}
                        </Typography>
                      </Typography>
                    );
                  })}
